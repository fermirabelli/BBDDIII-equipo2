...
namespace DCE05.Ejemplos.EstrellaUno.ReglasNegocio {
    ...
    public class CatalogoVentas {
        ...
        /// <exception cref="ReglasNegocioException">Si ocurre un error de negocio.</exception>
        public void ConfirmarVenta(Venta venta,int dni) {
            ...
            try {
                ...
                string sql = "INSERT ItemsVenta (CodigoVenta, CodigoProducto, Cantidad, CodigoUsuario) VALUES (@venta, @producto, @cantidad,@dni); SELECT @@IDENTITY";
